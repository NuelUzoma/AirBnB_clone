...
"""
    ...
    def test_help_EOF(self):
        ...
        s = 'The End of File for the console\n'
        self.assertEqual(s, f.getvalue())
    ...
    def test_help_create(self):
        ...
        s = 'Creates a new instance of a class and saves it to JSON File\n'
        self.assertEqual(s, f.getvalue())
    ...
    def test_help_count(self):
        ...
        s = 'Count the total number of an object in memory\n'
        self.assertEqual(s, f.getvalue())
    ...
    def test_help_update(self):
        ...
        s = 'Updates an instance based on class name and id\n'
        self.assertEqual(s, f.getvalue())
